/*
	Name:		Martin Smith, Manuel Mendez, Team (One/Two)
	Project:	{AlgorithmA}; 2011
	File:		binarytreeSrc.js
	Created:	2010.03.10
...
function changeToGreen(i)
{
    ...
    document.getElementById(i).src = "images/algorithm/breadthfirst/greencircle.gif";
}
function changeToRed(i)
{
    
    document.getElementById(i).src = "images/algorithm/breadthfirst/redcircle.gif";
}
function changeToBlack(i)
{
    
    document.getElementById(i).src = "images/algorithm/breadthfirst/circle.gif";
}
