...
*	Function Description:	places only the first node
						onto the tree then calls place() 
						to set the remaining nodes.
*********************************************************/
function insert()
{  
...
*	Function Description:	checks to see if numbers
						were entered in the form. If not it 
						alerts with a string. If so it sets the 
			 			value and calls code and insert function. 
*********************************************************/
