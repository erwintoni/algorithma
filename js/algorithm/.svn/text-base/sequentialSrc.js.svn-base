/*
	Name:		Justin Catrambone, David Sturgeon, Team (One/Two)
	Project:	{AlgorithmA}; 2011
	File:		sequentialSrc.js
	Created:	2010.02.17
...
function changeImageToRed(i){
	...
	MyImages[i].src = "images/algorithm/sequential/redcircle.gif";
...
function changeImageToBlack(i){
	...
	MyImages[i].src = "images/algorithm/sequential/circle.gif";
}

function changeImageToGreen(i){
	//color change for green dot and pseudo code highlighting
	MyImages[i].src = "images/algorithm/sequential/greencircle.gif";
