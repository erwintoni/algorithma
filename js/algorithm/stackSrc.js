/*
	Name:		Gerren Willis, Victor Herrera, Team (One/Two)
...
function selectText() 
{
   ...
   if(popping_back) // if you are poping back
   {
	  ...
	  document.getElementById("arrow" + stack_num).src = "images/algorithm/stack/blank.png";
	  if(stack_num>2)
	  {
	  document.getElementById("bottom"+ pickup).innerHTML = "Last";
	  document.getElementById("arrow" + stack_num_behind).src = "images/algorithm/stack/arrow.png";
	  }
   ...
   if(!popping_back) //if you are not popping back
   {
	...
	document.getElementById("arrow" + attatch).src = "images/algorithm/stack/arrow.png";
