/*
	...
	Functions:	
		...
		ChangeLine( nLineIndex, nRed, nGreen, nBlue, nStartingNode, nLineProgress ) : Changes the color of an existing line.  Is called by DrawLine.
		CreateWeight( nNode1Index, nNode2Index, nWeight, nNewLineIndex ) : Creates and places a div to display the weight of a line
*/
...
function CreateNode( nPosX, nPosY )
{
	...
	oNewDiv.style.backgroundImage = "url(../images/algorithm/prims/node.png)";
...
function RunAlgorithm()
{
	...
	document.getElementById( oaAllNodes[nStartingVertex].getId() ).style.backgroundImage = "url(../images/algorithm/prims/nodeInTree.png)";
...
function ChangeImage( nodeId )
{
	if ( document.getElementById( nodeId ).style.backgroundImage.match( "nodeInTree" ) )
		document.getElementById( nodeId ).style.backgroundImage = "url(../images/algorithm/prims/node.png)";
	else
		document.getElementById( nodeId ).style.backgroundImage = "url(../images/algorithm/prims/nodeInTree.png)";
}
