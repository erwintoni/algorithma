/*
	Name:		David Sturgeon, Justin Catrambone, 
...
function Insert()
{
	if(manager.complete){
	  ...
	  if( changed != "empty")
	  {
			  ...
			  newdiv.style.backgroundImage= "url(images/algorithm/2-3-4/capsule.png)";
	  }
...
function changeImg(ifound)
{
	...
	newdiv.style.backgroundImage= "url(images/algorithm/2-3-4/found.png)";
	changed = ifound;
	onlevel = false;
