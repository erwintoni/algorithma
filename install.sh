#!/bin/bash
#####################################################
#     {AlgorithmA}; 2011 Setup
#     Project Manager: Anthony Thomas
#     Server Team: Angel Zepeda, Crystal Bauza
#     OS: CentOS 5.4
#     Created by Anthony Thomas, Crystal Bauza, and Angel Zepeda
#
...
sleep 2
sudo tar -xzvf ~/algo2011.tar /var/www/html/algo
...
echo -e "\t\e[1;34m{AlgorithmA}; 2011\e[m has been installed
	Please open a browser and go to \e[1;31mhttp://localhost/algo/\e[m
	to view the \e[1;34m{AlgorithmA}; 2011\e[m project\n\n"
