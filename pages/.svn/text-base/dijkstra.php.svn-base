...
<div class="container"> 
	...
	<div class="tab_container" style="width:280px;"> 
		<div id="tab1" class="tab_content">   <div id="psuedo">
	...
	<div id="tab2" class="tab_content" style="font-size:small;"> 
		...
		<strong><div id="cppLine0">void dijkstra(startNode, endNode)</div></strong>
		<div id="cppLine1">{</div>
		<div id="cppLine2">&nbsp;&nbsp;&nbsp;Path[startNode] = 0;</div>	
		<div id="cppline3">&nbsp;&nbsp;&nbsp;while(Path.size())
		<div id="cppLine4">&nbsp;&nbsp;&nbsp;{</div>
		<div id="cppLine5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;temporary = minimum(Path);</div>
		<div id="cppLine6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for (start = Path.begin(); end = Path.end(); i++)</div>
		<div id="cppLine7">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{</div>
		<div id="cppLine8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if(edgeExist)</div>
		<div id="cppLine9">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;visited = false;</div>
		<div id="cppLine10">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</div>
		<div id="cppLine11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (visited)</div>
		<div id="cppLine12">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Backtrack()</div>
				...
				<!-- Begin View -->
						<td colspan="5">
							<div class="workarea" id="workarea">
                                ...
                                <img id="A" class="A" width="70" onClick="StartA('A')" height="70" src="images/algorithm/dijkstras/A.gif" />
                                <img id="B" class="B" width="70" onClick="StartA('B')" height="70" src="images/algorithm/dijkstras/B.gif" />
                                <img id="C" class="C" width="70" onClick="StartA('C')" height="70" src="images/algorithm/dijkstras/C.gif" />
                                <img id="D" class="D" width="70" onClick="StartA('D')" height="70" src="images/algorithm/dijkstras/D.gif" />
                                <img id="E" class="E" width="70" onClick="StartA('E')" height="70" src="images/algorithm/dijkstras/E.gif" />
